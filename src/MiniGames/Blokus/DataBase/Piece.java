...
package MiniGames.Blokus.DataBase;

import MiniGames.Blokus.DataBase.Pieces.*;
...
public abstract class Piece {
    ...
    private boolean mirror; //possible to mirror
    private int nbRotation; //1 to 4
    private int numberOfBlocks;
    private int totalConfig; //total number of configuration max 8 min 1
