package MiniGames.Blokus.Player;

import MiniGames.Blokus.DataBase.Piece;
import MiniGames.Blokus.DataBase.PieceFactory;
import MiniGames.Blokus.GameBoard.*;
import MiniGames.Blokus.GameBoard.*;
import MiniGames.Blokus.Move.Move;
import MiniGames.Blokus.Tools.*;
...
public abstract class Player {
    private int number;
    private List<Piece> piecesList = new ArrayList<Piece>();//list of pieces
    private List<Piece> piecesUsed = new ArrayList<Piece>(); //list of pieces used
    private String name;
    private boolean humanPlayer;
    private Color color;
    private Vector2d startingCorner;//corner where the player starts the game (0,0) for player 1
    private boolean skippedLastMove=false; //If the LAST move was not made due to no possible moves
    private int points=0;
    private boolean firstMove; // first time the player plays, he can place a piece in his starting corner
    private Stack <Move> moveLog = new Stack<>();
    private List<Piece> unplayablePiece;
